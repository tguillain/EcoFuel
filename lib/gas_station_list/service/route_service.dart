...
class RouteService {
  ...
  Future<RouteResult> fetchRoute({
    ...
    final Uri uri = Uri.parse('$_baseUrl/route/v1/driving/$coordinates')
        .replace(
          queryParameters: {
    ...
    final List<LatLng> points = coordinatesList.map((dynamic coordinate) {
      final List<dynamic> values = coordinate as List<dynamic>;

      final double longitude = (values[0] as num).toDouble();

      final double latitude = (values[1] as num).toDouble();
